...
from projects.uncertainbird.configs.experiment.Thesis.Convnext.MCD.convnext_dropout_hooks import attach_convnext_hooks, describe_convnext_setup, set_convnext_mc_mode
