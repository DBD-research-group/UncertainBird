...
def get_model_class(model_key: str) -> type[zoo_interface.EmbeddingModel]:
    ...
    if model_key in (
        ...
        module = importlib.import_module(
            "birdset.utils.perch_v2_utils.perch_hoplite.zoo.models_tf"
        )
        return _get_obj(module, "GoogleWhaleModel")
    elif model_key == "placeholder_model":
        module = importlib.import_module(
            "birdset.utils.perch_v2_utils.perch_hoplite.zoo.placeholder_model"
        )
        ...
        module = importlib.import_module(
            "birdset.utils.perch_v2_utils.perch_hoplite.zoo.aves_model"
        )
