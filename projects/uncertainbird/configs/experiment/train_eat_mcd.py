...
from eat_dropout_hooks import attach_eat_dropout_hooks, set_eat_mc_mode
...
def train(cfg):
    ...
    if cfg.get("test"):
        ...
        if cfg.get("MCTest", False):
            ...
            _eat_hooks = attach_eat_dropout_hooks(
                            target, p_resblock=0.1, p_down=0.05, p_head=0.5, p_token=0.0
                            )
