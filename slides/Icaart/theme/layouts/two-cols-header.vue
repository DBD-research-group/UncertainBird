...
<template>
    <div class="slidev-layout two-cols-header w-full h-full" :class="layoutClass">
        ...
        <div class="col-left mt-2" :class="props.class">
            <slot name="left" />
        </div>
        <div class="col-right mt-2" :class="props.class">
            <slot name="right" />
        </div>
...
.two-cols-header {
    ...
    /* Changed rows to auto 1fr auto */
    height: 100%;
    /* Make sure the grid takes the full height */
}
